...
public enum CollectionFormat {
	 ...
	 *
	 * <p>
	 * Null values are treated somewhat specially. With EXPLODED, the field is
	 * repeated without any "=" for backwards compatibility. With all other formats,
	 * null values are not included in the joined value list.
	 * </p>
	 *
	 * @param field
	 *            The field name corresponding to these values.
	 * @param values
	 *            A collection of value strings for the given field.
	 * @param charset

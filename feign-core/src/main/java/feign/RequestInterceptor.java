 ...
 * as adding headers to all requests. No guarantees are give with regards to the
 * order that interceptors are applied. Once interceptors are applied,
 * {@link Target#apply(RequestTemplate)} is called to create the immutable http
 * request sent via {@link Client#execute(Request, feign.Request.Options)}. <br>
 * <br>
 * For example: <br>
 * 
 * <pre>
 ...
 * <br>
 * {@code RequestInterceptors} are configured via
 * {@link Feign.Builder#requestInterceptors}. <br>
 * <br>
 * <b>Implementation notes</b><br>
 * <br>
 * Do not add parameters, such as {@code /path/{foo}/bar } in your
 * implementation of {@link #apply(RequestTemplate)}. <br>
 ...
 * that you can implement signatures are interceptors. <br>
 * <br>
 * <br>

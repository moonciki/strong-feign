 ...
 * <br>
 * Similar to {@code
 * javax.ws.rs.client.WebTarget}, as it produces requests. However,
 * {@link RequestTemplate} is a closer match to {@code WebTarget}.
 *
 * @param <T>
...
public interface Target<T> {
	 ...
	 * target-specific headers or query parameters. <br>
	 * <br>
	 * For example: <br>
	 * 
	 * <pre>
	 ...
	 * javax.ws.rs.client.WebTarget.request()}, except that we expect transient, but
	 * necessary decoration to be applied on invocation.
	 */
	public Request apply(RequestTemplate input);

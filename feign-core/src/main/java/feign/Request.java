...
public final class Request {
	...
	/**
	 * No parameters can be null except {@code body} and {@code charset}. All
	 * parameters must be effectively immutable, via safe copies, not mutating or
	 * otherwise.
	 *
	...
	/**
	 * Builds a Request. All parameters must be effectively immutable, via safe
	 * copies.
	 *
	 * @param httpMethod
	 *            for the request.
	 ...
	 *            to include.
	 * @param body
	 *            of the request, can be {@literal null}
	 * @param charset
	 *            of the request, can be {@literal null}
	 * @return a Request
	 */
	...
	/**
	 * The character set with which the body is encoded, or null if unknown or not
	 * applicable. When this is present, you can use
	...
	/**
	 * If present, this is the replayable body to send to the server. In some cases,
	 * this may be interpretable as text.
	 *
	 * @see #charset()
	 * @deprecated use {@link #requestBody()} instead
	 */
	...
	public static class Options {
		...
		/**
		 * Defaults to true. {@code false} tells the client to not follow the
		 * redirections.
		 *

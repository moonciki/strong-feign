...
abstract class Expression implements TemplateChunk {
	 ...
	 *            of the variable
	 * @param pattern
	 *            the resolved variable must adhere to, optional.
	 */
	...
	/**
	 * Checks if the provided value matches the variable pattern, if one is defined.
	 * Always true if no pattern is defined.
	 *
	 * @param value
	 *            to check.

...
public class UriUtils {
	...
	/**
	 * Uri Encode the value, using the default Charset. Already encoded values are
	 * skipped.
	 *
	 * @param value
	 *            to encode.
	...
	public static String pathEncode(String path, Charset charset) {
		...
		/*
		 * path encoding is not equivalent to query encoding, there are few differences,
		 * namely dealing with spaces, !, ', (, ), and ~ characters. we will need to
		 * manually process those values.
		 */
	 ...
	 *
	 * @param queryParam
	 *            containing the query parameter.
	 * @param charset
	 *            to use.
	 * @return the encoded query fragment.
	 */
	...
	/**
	 * Encodes the value, preserving all reserved characters.. Values that are
	 * already pct-encoded are ignored.
	 *
	 * @param value
	 *            inspect.
	 * @param type
	 *            identifying which uri fragment rules to apply.
	 * @param charset
	 *            to use.
	...
	public static String encodeReserved(String value, FragmentType type, Charset charset) {
		/*
		 * value is encoded, we need to split it up and skip the parts that are already
		 * encoded
		 */

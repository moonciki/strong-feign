...
/**
 * URI Template, as defined by <a href="https://tools.ietf.org/html/rfc6570">RFC
 * 6570</a>, supporting
 * <a href="https://tools.ietf.org/html/rfc6570#section-3.2.2">Level 1</a>
 * expressions, with the following differences:
 *
 * <ol>
...
public class UriTemplate extends Template {
	 ...
	 *            representing the uri
	 * @param encodeSlash
	 *            flag if slash characters should be encoded.
	 * @param charset
	 *            for the template.
	 * @return a new Uri Template instance.
	 */
	 ...
	 *            for the uri.
	 * @param encodeSlash
	 *            flag for encoding slash characters.
	 * @param charset

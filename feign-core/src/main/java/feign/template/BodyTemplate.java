...
/**
 * Template for @{@link feign.Body} annotated Templates. Unresolved expressions
 * are preserved as literals and literals are not URI encoded.
 */
public final class BodyTemplate extends Template {
	...
	public String expand(Map<String, ?> variables) {
		...
		if (this.json) {
			...
			sb.append(expanded, expanded.indexOf(JSON_TOKEN_START_ENCODED) + JSON_TOKEN_START_ENCODED.length(),

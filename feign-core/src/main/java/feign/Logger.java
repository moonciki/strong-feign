...
/**
 * Simple logging abstraction for debug messages. Adapted from
 * {@code retrofit.RestAdapter.Log}.
 */
public abstract class Logger {
	 ...
	 *
	 * @param configKey
	 *            value of {@link Feign#configKey(Class, java.lang.reflect.Method)}
	 * @param format
	...
	public static class JavaLogger extends Logger {
		...
		/**
		 * Helper that configures java.util.logging to sanely log messages at FINE level

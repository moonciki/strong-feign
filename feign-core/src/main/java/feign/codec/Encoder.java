 ...
 * {@code javax.websocket.Encoder}. {@code
 * Encoder} is used when a method parameter has no {@code @Param} annotation.
 * For example: <br>
 * <p/>
 * 
 * <pre>
 ...
 * <h3>Form encoding</h3>
 * <p>
 * If any parameters are found in {@link feign.MethodMetadata#formParams()},
 * they will be collected and passed to the Encoder as a map.
 *
 * <p>
 * Ex. The following is a form. Notice the parameters aren't consumed in the
 * request line. A map including "username" and "password" keys will passed to
 * the encoder, and the body type will be {@link #MAP_STRING_WILDCARD}.
 * 
 * <pre>
 * &#064;RequestLine(&quot;POST /&quot;)
...
public interface Encoder {
	 ...
	 *
	 * @param object
	 *            what to encode as the request body.
	 * @param bodyType
	 *            the type the object should be encoded as.

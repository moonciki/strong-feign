...
/**
 * Tests client-specific behavior, such as ensuring Content-Length is sent when
 * specified.
 */
public class DefaultClientTest extends AbstractClientTest {
	...
	public void retriesFailedHandshake() throws IOException, InterruptedException {
		...
		TestInterface api = newBuilder().target(TestInterface.class, "https://localhost:" + server.getPort());
	...
	/**
	 * We currently don't include the
	 * <a href="http://java.net/jira/browse/JERSEY-639">60-line workaround</a>
	 * jersey uses to overcome the lack of support for PATCH. For now, prefer
	 * okhttp.
	 *
	...
	public void canOverrideHostnameVerifier() throws IOException, InterruptedException {
		...
		TestInterface api = Feign.builder().client(disableHostnameVerification).target(TestInterface.class,

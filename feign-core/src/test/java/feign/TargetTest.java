...
public class TargetTest {
	...
	/**
	 * Per <a href="https://github.com/Netflix/feign/issues/227">#227</a>, some may
	 * want to opt out of percent encoding. Here's how.
	 */
	@Test
	public void targetCanCreateCustomRequest() throws InterruptedException {
		...
		Target<TestQuery> custom = new HardCodedTarget<TestQuery>(TestQuery.class, baseUrl) {
			...
			public Request apply(RequestTemplate input) {
				...
				return Request.create(urlEncoded.httpMethod(), urlEncoded.url().replace("%2F", "/"),
						urlEncoded.headers(), urlEncoded.requestBody().asBytes(), urlEncoded.charset());
			}
		};

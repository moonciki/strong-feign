...
public class EmptyTargetTest {
	...
	public void toString_withoutName() {
		assertThat(EmptyTarget.create(UriInterface.class).toString()).isEqualTo("EmptyTarget(type=UriInterface)");
	}
	...
	public void mustApplyToAbsoluteUrl() {
		...
		EmptyTarget.create(UriInterface.class).apply(new RequestTemplate().method(HttpMethod.GET).uri("/relative"));
	}
